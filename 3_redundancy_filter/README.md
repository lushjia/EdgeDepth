...
1. Per-chromosome raw edge-depth matrices containing all edges: `chr*.depth_per_edge.txt.gz`    

2. A text file containing one representative edge per row (`chr*.independent_edge_list.txt`).        
Example:
```
>105404484>105404486
>105407282>105407291
```
3. Filtered normalized edge-by-sample matrix (`chr21.independent_edge_list.normalized_depth.txt`)    
